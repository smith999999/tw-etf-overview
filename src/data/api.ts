...
const STATIC_NAV: Record<string, number> = {
  ...
  '00981A': 15.00, '00991A': 15.00, '00992A': 15.00, '00987A': 15.00,
  '00982A': 15.00, '00985A': 15.00, '00980A': 15.00, '00984A': 15.00,
  '00403A': 15.00,
};

const STATIC_PRICE: Record<string, number> = {
  '00945': 10.95, // Fallback price for 00945 if API fails
  '00981A': 15.10, '00991A': 15.05, '00992A': 15.20, '00987A': 14.90,
  '00982A': 15.15, '00985A': 14.95, '00980A': 15.25, '00984A': 15.05,
  '00403A': 15.10,
};
